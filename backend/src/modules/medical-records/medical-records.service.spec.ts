...
describe('MedicalRecordsService', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getRepositoryToken(RecordTemplate),
          useValue: mockTemplateRepo,
        },
        {
          provide: getRepositoryToken(RecordVersion),
    ...
    mockMedicalRecordRepo.createQueryBuilder.mockImplementation(() => ({
  ...
  describe('findAll', () => {
    ...
    it('should return records filtered by recordType', async () => {
      ...
      const result = await service.findAll(undefined, RecordType.SURGERY);
  ...
  describe('verifyRecord', () => {
    ...
    it('should throw BadRequestException if already verified', async () => {
      ...
      await expect(service.verifyRecord('rec-1', verifyDto)).rejects.toThrow(
        BadRequestException,
      );
    });
  });
  ...
  describe('revokeVerification', () => {
    ...
    it('should revoke verification and create version snapshot', async () => {
      ...
      const result = await service.revokeVerification(
        'rec-1',
        revokeDto,
        'user-1',
      );
  ...
  describe('getRecordVersions', () => {
    ...
    it('should throw NotFoundException if record not found', async () => {
      ...
      await expect(service.getRecordVersions('nonexistent')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('saveAttachment', () => {
    ...
    it('should reject disallowed file types', async () => {
      ...
      await expect(service.saveAttachment(file)).rejects.toThrow(
        BadRequestException,
      );
    });
