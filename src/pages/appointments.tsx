  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-blue-50 to-green-50 flex flex-col font-sans text-gray-900">
      <Head>
        ...
        <meta name="description" content="Manage your pet's veterinary appointments." />
      </Head>
      ...
      <main className="flex-grow container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3">
            {viewMode === 'calendar' ? <CalendarView /> : <VetAvailabilityList />}
          </div>
      ...
      {isBookingModalOpen && <BookingModal onClose={() => setBookingModalOpen(false)} />}
