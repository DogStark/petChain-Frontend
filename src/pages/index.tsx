...
const FEATURES = [
  {
    ...
    icon: "🐾",
    details:
      "Each pet receives a unique QR code tag that links directly to their medical history. Vets and emergency responders can scan the tag to instantly access vital information, including allergies, medications, and a custom message from the owner. The tag can also act as a tracker if your pet goes missing.",
  },
  {
    ...
    icon: "🔗",
    details:
      "All medical records are securely stored on Stellar, ensuring they are tamper-proof and always accessible. No more lost or scattered records—access your pet’s health history from anywhere, at any time.",
  },
  {
    ...
    icon: "🔒",
    details:
      "You decide who can view your pet’s records. Share only vaccination status publicly, or grant full access to a trusted vet. Your pet’s privacy and safety are always in your hands.",
  },
  {
    ...
    icon: "📅",
    details:
      "Receive timely reminders for upcoming vaccinations, check-ups, and treatments. Stay on top of your pet’s health schedule with smart, automated notifications.",
  },
  {
    ...
    icon: "💻",
    details:
      "PetChain is designed to integrate seamlessly with veterinary and hospital management systems, making it easy for professionals to access and update records with minimal friction.",
  },
  {
          ...
          <div className="relative w-full overflow-x-hidden mt-4">
            <div className="animate-marquee whitespace-nowrap">
              <span className="inline-block bg-gradient-to-r from-blue-400 via-pink-400 to-green-400 bg-clip-text text-transparent font-bold px-6 py-2 rounded-full shadow-md text-2xl md:text-3xl">
                ...
                Private & Vet-Ready. &nbsp; Decentralized, Private & Vet-Ready.
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 flex flex-col items-center bg-gradient-to-r from-blue-50 via-pink-50 to-green-50 rounded-3xl mx-2 md:mx-16 mb-8">
        ...
        <ol className="space-y-4 max-w-2xl text-lg text-gray-700">
          <li className="flex items-start">
            <span className="mr-3 text-2xl">1.</span> Register your pet and
            receive a unique QR tag.
          </li>
          <li className="flex items-start">
            <span className="mr-3 text-2xl">2.</span> Scan the tag to access or
            update medical records—anytime, anywhere.
          </li>
          <li className="flex items-start">
            <span className="mr-3 text-2xl">3.</span> Control access and get
            smart reminders for your pet’s health needs.
          </li>
        </ol>
      </section>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8">
          <div className="flex-1 text-center">
            ...
            <p className="text-gray-700">
              Blockchain ensures records are tamper-proof, permanent, and
          ...
          <div className="flex-1 text-center">
            ...
            <p className="text-gray-700">
              Zero-knowledge proofs and encryption keep your pet’s data
              private—even on-chain.
            </p>
          </div>
          <div className="flex-1 text-center">
            <h3 className="text-xl font-semibold mb-2">Seamless Integration</h3>
            <p className="text-gray-700">
              Works with vet/hospital software and supports offline access for
              emergencies.
            </p>
          </div>
        </div>
...
function FeatureCard({
  ...
  return (
    <button
      ...
      type="button"
    >
      <div className="text-4xl mb-3 transition-transform group-hover:scale-125 group-hover:-rotate-6">
        {icon}
      </div>
