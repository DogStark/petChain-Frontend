        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 print:hidden">
            <div>
              ...
              <p className="text-slate-500 mt-1">
                Generate and export comprehensive platform insights
              </p>
            </div>
            <button
              onClick={handlePrint}
          ...
          <div ref={reportRef} className="print:p-0">
            ...
            <div className="hidden print:block mb-8 border-b pb-4">
              ...
              <p className="text-slate-500 mt-1">
                Category: {tabs.find((t) => t.id === activeTab)?.label} | Generated on:{' '}
                ...
                <div className="bg-gradient-to-br from-indigo-500 to-blue-600 p-6 rounded-3xl shadow-lg text-white flex flex-col justify-between">
                  ...
                  <div className="mt-8">
                    ...
                    <p className="text-indigo-100 mt-2 flex items-center gap-2">
                      <span className="bg-white/20 px-2 py-1 rounded text-sm">+12.5%</span> from
                      last month
                    </p>
                  </div>
                </div>
                      ...
                      {[
                        {
                          ...
                          freq: 'Weekly (Monday)',
                          rec: 'admin@petchain.com',
                          next: 'Oct 24, 08:00 AM',
                        },
                        {
                          name: 'Monthly Financial Audit',
                          freq: 'Monthly (1st)',
                          rec: 'finance@petchain.com',
                          next: 'Nov 01, 12:00 AM',
                        },
                        {
                          name: 'Daily System Health',
                          freq: 'Daily',
                          rec: 'devops@petchain.com',
                        ...
                        <tr key={i} className="border-b border-slate-100 hover:bg-slate-50/50">
                          ...
                          <td className="py-4 text-slate-600 text-sm">
                            <span className="px-2.5 py-1 bg-slate-100 rounded-full text-slate-700">
                              {report.freq}
                            </span>
                          </td>
            ...
            {activeTab === 'templates' && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 print:hidden">
                {[
                  {
                    title: 'Executive YTD Summary',
                    desc: 'High-level aggregation of revenue, user growth, and critical system health alerts.',
                    color: 'from-blue-500 to-indigo-600',
                  },
                  {
                    title: 'Clinical Operations',
                    desc: 'Granular view of appointments, procedures, and veterinary facility engagement.',
                    color: 'from-emerald-400 to-teal-500',
                  },
                  {
                    title: 'Network Performance',
                    desc: 'Detailed metrics on API latency, error rates, and Blockchain transaction gas costs.',
                    color: 'from-slate-700 to-slate-900',
                  },
                  {
                    title: 'Compliance Audit',
                    desc: 'Logs of data access, profile modifications, and privacy consent status.',
                    color: 'from-violet-500 to-purple-600',
                  },
                ].map((template, i) => (
                  <div
                    key={i}
                    className="group cursor-pointer bg-white rounded-3xl p-6 shadow-md border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full"
                  >
                    <div
                      className={`w-12 h-12 rounded-2xl mb-4 bg-gradient-to-br ${template.color} shadow-inner flex items-center justify-center`}
                    >
                      <FileText className="w-6 h-6 text-white" />
                    </div>
                    <h3 className="text-xl font-bold text-slate-800 mb-2">{template.title}</h3>
                    <p className="text-slate-500 flex-grow text-sm leading-relaxed">
                      {template.desc}
                    </p>
