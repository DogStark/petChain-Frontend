...
import { Star, MapPin, Clock, Calendar, ShieldCheck, Heart, Award, Share2 } from 'lucide-react';
...
const MOCK_CLINIC_DETAILS: Clinic = {
  ...
  services: [
    {
      id: 's1',
      name: 'Consultation',
      description: 'Comprehensive physical examination and medical history review.',
      priceRange: '£55.00',
    },
    {
      id: 's2',
      name: 'Core Vaccinations',
      description: 'Protection against common infectious diseases tailored to your pet.',
      priceRange: '£45.00',
    },
    {
      id: 's3',
      name: 'Professional Dental',
      description: 'Ultrasonic scaling, polishing, and oral assessment under sedation.',
      priceRange: '£220.00',
    },
    {
      id: 's4',
      name: 'Wellness Profile',
      description: 'Advanced blood panel, urinalysis, and early detection screening.',
      priceRange: '£110.00',
    },
    {
      id: 's5',
      name: 'Microchipping',
      description: 'Permanent identification for your pet with international registration.',
      priceRange: '£25.00',
    },
  ],
  hours: [
  ...
  reviews: [
    ...
    },
    {
      ...
      rating: 4,
      comment: 'Great clinic, bit of a wait sometimes but the quality of care is worth it.',
      date: '2023-11-15',
    },
    {
      id: 'r3',
      ...
      rating: 5,
      comment: 'My cat is actually happy to go there! Modern equipment and very clean environment.',
      date: '2023-11-20',
    },
  ],
};
...
export default function ClinicProfile() {
  const [activeTab, setActiveTab] = useState<'services' | 'staff' | 'locations' | 'reviews'>(
    'services'
  );
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-blue-50 to-green-50 flex flex-col font-sans text-gray-900">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div className="max-w-3xl">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1 bg-white/20 backdrop-blur-md rounded-full border border-white/30 text-white text-xs font-bold">
                    ...
                    {MOCK_CLINIC_DETAILS.rating} Rating • {MOCK_CLINIC_DETAILS.reviewCount} Reviews
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-3">
                <button className="px-8 py-4 bg-white text-blue-900 font-black rounded-2xl shadow-2xl hover:bg-blue-50 transition-all flex items-center justify-center gap-3 transform hover:scale-[1.02] active:scale-[0.98]">
                  <Calendar className="w-5 h-5 text-blue-600" /> Book an Appointment
                </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="min-h-[400px] animate-fade-in">
              {activeTab === 'services' && <ServiceList services={MOCK_CLINIC_DETAILS.services} />}
              {activeTab === 'staff' && <StaffList staff={MOCK_CLINIC_DETAILS.staff} />}
              {activeTab === 'locations' && (
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <section className="bg-white rounded-[2rem] p-8 shadow-2xl border border-blue-50 relative overflow-hidden group">
              ...
              <div className="relative">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-black text-blue-900">Operating Hours</h3>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                  <p className="text-xs text-gray-400 mb-1">Emergency Line (24/7)</p>
                  <a
            ...
            <section className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[2rem] p-8 text-white shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-xl font-black mb-4 relative">Partner with Us</h3>
              <p className="text-blue-100 text-sm mb-6 leading-relaxed relative">
                Are you a vet clinic looking to join the PetChain network of premium healthcare
                providers?
              </p>
      ...
      <footer className="mt-20 py-12 bg-white border-t border-gray-100 text-center">
        <p className="text-gray-400 font-medium">
          © 2024 PetChain Healthcare Directory. Trusted by pets and humans alike.
        </p>
      </footer>
    </div>
  );
